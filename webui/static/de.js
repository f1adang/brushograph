...
"Six small routines: zeroing the controller through a mostly fixed sequence, parking the brush, replacing paper, washing the brush then parking it, placing a single reference dot on the canvas, and drawing the sheet that the play in each axis is measured off — that one wants a pen fitted where the brush goes and paper across the whole bed, and visits no cup. Clean follows whichever container shape is set under Containers; calibrate does neither, but it lifts clear like the rest before it crosses — just the dot, and a park over it.":
  "Sechs kleine Abläufe: die Steuerung über eine weitgehend feste Folge auf Null setzen, den Pinsel abstellen, das Papier wechseln, den Pinsel waschen und abstellen, einen einzelnen Bezugspunkt auf den Druckbereich setzen und das Blatt zeichnen, an dem sich das Spiel beider Achsen messen lässt — für dieses gehört ein Stift dorthin, wo sonst der Pinsel sitzt, und Papier über die ganze Arbeitsfläche; es fährt keinen Behälter an. Die Reinigung richtet sich nach der unter „Behälter“ eingestellten Behälterform; die Kalibrierung tut das nicht, hebt aber wie die übrigen ab, ehe sie die Fläche quert — nur der Punkt und eine Ruhestellung darüber.",
...
"Rectangular containers: how many times the brush sweeps across the cup, down at Dip Depth, before it swipes up the stairs. Each sweep stirs the paint and loads the bristles; the swipe out is also what wipes them, so the stirring happens first. 0 goes straight up the stairs. The sweep runs across X, keeping 15% of the cup's width off each wall, and the water cup's greater width is used for it.":
  "Rechteckige Behälter: wie oft der Pinsel unten auf Tauchtiefe quer durch den Behälter fährt, bevor er die Stufen hinaufstreicht. Jeder Zug rührt die Farbe auf und lädt die Borsten; der Zug hinaus ist zugleich das Abstreifen, darum wird zuvor gerührt. 0 fährt unmittelbar die Stufen hinauf. Der Zug verläuft in X-Richtung und hält je 15% der Behälterbreite von jeder Wand Abstand; beim Wasserbehälter gilt dessen größere Breite.",
...
"note-mix": "<b>Rührzüge</b> gibt an, wie oft der Pinsel unten auf Tauchtiefe quer durch einen rechteckigen Behälter fährt, bevor er die Stufen hinauf und hinausstreicht. Jeder Zug rührt die Farbe auf und arbeitet sie in die Borsten; der Zug hinaus ist zugleich das Abstreifen, darum wird zuvor gerührt. Die runden Näpfe haben stets eine Sehne unten in der Farbe gezogen — dies ist ebendas, für die Tiegel. 0 fährt unmittelbar die Stufen hinauf, wie bisher. Der Zug bleibt innerhalb des Verfahrwegs der Maschine, was bei einem Halter zählt, dessen breitester Behälter über einen Endschalter hinausragt.",
