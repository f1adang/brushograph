...
"Cup Mix Offset": "Versatz des Halters",
...
"How far right the holder really sits along X, against where the container positions put it (mm; negative is left). Only the mixing sweep uses it: a dip and a swipe go to the centre, where being a couple of millimetres out never showed, but a sweep the width of the cup runs up against a wall. Set it by watching the sweep — if it crowds the left wall, add a millimetre or two.":
  "Wie weit rechts der Halter tatsächlich in X steht, gegenüber dem, was die Behälterpositionen angeben (mm; negativ ist links). Nur der Rührzug benutzt ihn: Eintauchen und Streichzug laufen zur Mitte, wo ein paar Millimeter Abweichung nie auffielen, ein Zug über die Behälterbreite aber gegen eine Wand gerät. Stellen Sie ihn ein, indem Sie den Zug beobachten — drängt er an die linke Wand, geben Sie einen oder zwei Millimeter zu.",
